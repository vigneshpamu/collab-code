		...
		if (path === '/api/virtualbox') {
			if (method === 'GET') {
				...
				if (params.has('id')) {
					...
					// const deleteStorageRequest = new Request('https://storage.vigneshpamu2002.workers.dev/api/project', {
					// 	method: 'DELETE',
				...
				const initStorageRequest = new Request(`https://storage.vigneshpamu2002.workers.dev/api/init`, {
					method: 'POST',
